const tasks = {
    ...
    task6: function () {
        ...
        return alert(`Hello ${lastName} ${firstName}`);
    },
    task7: function () {
    ...
    task13: function () {
        ...
        return alert(`The volume of the sphere is: ${volume}`);
    },
    task14: function () {
        let str = prompt('Input string');
        if (str === null || str.trim().length === 0) {
            return alert(`Wrong string!`);
        }
    ...
    task16: function () {
        ...
        return alert(`max = ${Math.max(a, b, c)}`);
    },
    task17: function () {
        ...
        if (num > 10 && num < 100) {
            return alert(`Your number ${num} is in range from 10 to 100`);
        } else if (num > 100 && num < 200) {
            return alert(`Your number ${num} is in range from 100 to 200`);
        } else {
            return alert(`You number ${num} is outside our range`);
        }
    },
    task18: function () {
        ...
        if (a === b) {
            return alert(`a equal b. Double sum is: ${(a + b) * 2}`)
        } else {
            return alert(`Their sum is: ${a + b}`);
        }
    },
    ...
    task26: function () {
        ...
        return alert(`Total marks: ${arr.reduce((a, b) => a + b)}`)
    },
    task27: function () {
    ...
    task28: function () {
        ...
        if (isNaN(year)) {
            return alert(`Wrong year`);
        }
        if (year % 4 === 0) {
            return alert(`${year} is leap year`);
        } else {
            return alert(`${year} is not  leap year`);
        }
    },
    task29: function () {
        let str = prompt(`Input your string`);
    ...
    task30: function () {
        ...
        let res = `${str[0]}${str[1]}`;
        if (res === 'ps') {
            return alert(`New string is - ${res}`);
        } else {
            res = '';
            return alert(`New sting is - ${res}(blank string)`);
        }
    },
    task31: function () {
        ...
        return alert(`Nearest number to ${border} from your value is - ${nearest}`);
    },
    task32: function () {
        const a = parseInt(prompt(`Input first value`, 0));
        const b = parseInt(prompt(`Input second value`, 0));
        if (isNaN(a) || isNaN(b) || a < 0 || b < 0) {
            return alert(`Wrong values`);
        }
    ...
    task37: function () {
        ...
        if (a === 11 || b === 11) {
            ...
            return alert(`Their difference is 11`);
        } else {
            return alert(`
    ...
    task42: function () {
        ...
        return alert(`They will meet ${res}km from B city`);
    },
    task43: function () {
        const range = parseFloat(prompt(`Input the range between A and B`, 0));
    ...
    task46: function () {
        ...
        return alert('The sum of all elements is: ' + sum + '\nsame numbers ' + res + '\nsum parts - ' + str);
    },
    task47: function () {
        ...
        if (next != 2) {
            return alert(`Wrong time format(use like this: 14:50)`);
        }
        ...
        if (arrival[0] * 1 < 0 || arrival[0] * 1 > 24 || arrival[1] * 1 < 0 || arrival[1] * 1 >= 60) {
            return alert(`Wrong time to arrival. Press f5 to try again!`);
        } else if (departure[0] * 1 < 0 || departure[0] * 1 > 24 || departure[1] * 1 < 0 || departure[1] * 1 >= 60) {
            return alert(`Wrong time to departure. Press f5 to try again!`);
        }
        let price = prompt(`Input price per one hour`, 0);
        if (price === null || price.trim().length === 0) {
            return alert(`Wrong price. Press f5 to try again`);
        }
        price = price.trim();
        ...
        pay = pay[0] * price;
        result = result.split(':');
        return alert('Your car was standing in the parking lot: ' + result[0] + 'h:' + result[1] + 'min' + '\nYou must to pay: ' + pay + "$");
    }
};
tasks.task1();